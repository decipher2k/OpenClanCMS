...
<table class="forum" cellpadding="0" cellspacing="{page:cellspacing}" style="width:{page:width}">
 ...
 <tr>
  <td class="leftb">{lang:category} {cats:dropdown} <input type="submit" name="submit" value="{lang:show}" /></td>
...
<table class="forum" cellpadding="0" cellspacing="{page:cellspacing}" style="width:{page:width}">
 <tr>
  <td class="newshead">
   <div class="cp-news-head">
    <strong>{news:news_headline}</strong>
    <span class="cp-news-category">{news:categories_name}</span>
   </div>
  </td>
 </tr>
 <tr>
  <td class="bottom">
   <div class="cp-news-meta">
    ...
    <span>{news:comments_link} ({news:comments_count})</span>
   </div>
  </td>
 </tr>
 <tr>
  <td class="leftb cp-news-body">{if:catimg}
